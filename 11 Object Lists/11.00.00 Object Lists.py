"""
*11.00.00 Creating a List of Objects Using Instantiation
Creating a list of object is no different than creating any other list. In this case, we append an object rather than a number or string. We can access objects in the list by using an index.

Copy, paste and save the file below as 11.00.01 Balls.txt
...
Check out lines 43-53.

Line 47 - split the data read from the file into a list congaing values for the object
Line 50 - create the object
Line 51 - append the object to the list
Note the new function: find_ball. It searches the ball list looking for a match. It returns the index where the ball was found. Look in Line 55 toe see the use of find_ball.
...
'''Copy, paste and run the above code as 11.00.00 Object List Instantiation.py'''